...
- **Salvaguardas de silk que eram promessa vazia.** O aviso de "marcador de pino 1 apagado pelo recorte" nunca disparava (o atributo nunca era marcado em `draw_pin1_marker`); silk aninhado era pulado sem aviso; e o docstring prometia um aviso de círculo-sobre-pad inexistente. As três agora funcionam de verdade — falha silenciosa vira aviso. Também: folga de pad de exatamente 0,2 mm deixou de gerar o aviso contraditório "0.200mm (< 0.20mm)" (ruído de ponto flutuante).
